  ...
  return (
    ...
    >
      <div className="flex items-center h-full w-full relative">
        ...
        <motion.a
          href="/"
          className="flex items-center mr-8 z-10"
        ...
        <div className="hidden md:flex items-center space-x-5 ml-auto z-10">
          {loading ? null : user ? (
            <>
              {user.role === 'admin' && (
                <a href="/admin/dashboard" className="text-gray-600 hover:text-lavender transition-colors text-xs font-medium">
                  Admin
                </a>
              )}
              <a href="/profile" className="text-gray-600 hover:text-lavender transition-colors" title="Profile">
              ...
              <div className="px-6 py-4 border-b border-gray-200">
                <div className="relative w-full">
                  ...
                  />
                    ...
                    {user.role === 'admin' && (
                      <a href="/admin/dashboard" className="text-gray-600 hover:text-lavender transition-colors text-base font-medium" onClick={() => setIsOpen(false)}>
                        Admin
                      </a>
                    )}
                    <a href="/profile" className="text-gray-600 hover:text-lavender transition-colors flex items-center" title="Profile" onClick={() => setIsOpen(false)}>
                      <User className="w-5 h-5 mr-2" /> Profile
                    </a>
                    <a href="/cart" className="relative flex items-center" onClick={() => setIsOpen(false)}>
