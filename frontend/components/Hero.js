  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center pointer-events-none">
        <motion.div
          className="pointer-events-auto" // only the content (especially button) should be clickable
        ...
        >
          ...
          {/* MAGIC FIX: Use <a> instead of router.push */}
          <motion.a
            href="/products"
            className="relative inline-block bg-gradient-to-r from-lavender to-purple-600 text-white px-10 py-4 text-lg font-bold shadow-2xl rounded-xl overflow-hidden group"
