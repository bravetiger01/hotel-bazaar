      ...
      <div className="absolute left-1/2 top-1/2 z-20 -translate-x-1/2 -translate-y-1/2 text-center">
        ...
        >
          ...
          <button
            ...
            className="relative bg-gradient-to-r from-lavender to-purple-600 text-white px-10 py-4 text-lg font-bold shadow-2xl rounded-xl overflow-hidden group inline-block cursor-pointer hover:scale-105 transition-transform duration-300"
          >
