              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <motion.button
                    ...
                    className="w-12 h-12 rounded-full bg-gray-200 hover:bg-lavender hover:text-white transition-colors flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                  ...
                  <motion.button
                    ...
                    disabled={quantity >= Math.min(10, product.stock || 0) || !product.stock}
                    className="w-12 h-12 rounded-full bg-gray-200 hover:bg-lavender hover:text-white transition-colors flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
                  >
